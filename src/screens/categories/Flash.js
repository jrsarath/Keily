...
export class FlashScreen extends Component {
  ...
  componentDidMount() {
      const get = "posts?categories=56&per_page=99";
      ...
      if (index === '0') {
        return (
          <View>
            ...
            <Title style={{paddingTop:15,paddingBottom:15,width:'100%', textAlign:'center'}}>More Flash News</Title>
          </View>
        );
      }
